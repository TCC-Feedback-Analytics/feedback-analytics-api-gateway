...
CREATE POLICY "Auth gerencia respostas de subperguntas" ON "feedback_subquestion_answers" AS PERMISSIVE FOR ALL TO "authenticated";--> statement-breakpoint
...
CREATE POLICY "Usuários autenticados podem gerenciar dispositivos" ON "tracked_devices" AS PERMISSIVE FOR ALL TO "authenticated";